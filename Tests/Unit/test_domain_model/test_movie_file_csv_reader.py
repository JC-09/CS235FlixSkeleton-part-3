...
class TestMovieFileCSVReader:
    def test_attribute(self):
        ...
        filename = 'CS235Flix/adapters/datafiles/movies.csv'    # use this if running tests via 'python3 -m pytest' in terminal
        # filename = '../CS235Flix/adapters/datafiles/movies.csv'   # use this if running tests via right click Tests folder and select "Run pytest in tests"
